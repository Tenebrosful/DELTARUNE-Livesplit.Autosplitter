...
state("DELTARUNE", "CH1-5 v244")
{
    ...
    double floweryDollars : 0x6A9CA8, 0x48,  0x10,   0x6BB0, 0x0,  0x90, 0x5830;      // global.flag[1411]
...
state("DELTARUNE", "CH1-5 v247")
{
    ...
    string128 text_ch5    : 0x8CE220, 0x18,  0x90,   0x0,    0x0,  0x0;
    double pinkCoins      : 0x6A9CA8, 0x48,  0x10,   0x6BA0, 0x0,  0x90, 0x5200;
    double floweryDollars : 0x6A9CA8, 0x48,  0x10,   0x6BA0, 0x0,  0x90, 0x5830;
...
state("DELTARUNE", "CH1-5 v253")
{
    ...
    double fight_ch2        : 0x6A9CA8, 0x48,  0x10,  0x120,  0x0;
    double choicer_ch2      : 0x6A9CA8, 0x48,  0x10,  0x74C0, 0x0;
    double msc_ch2          : 0x6A9CA8, 0x48,  0x10,  0x7330, 0x0;
    string128 text_ch2      : 0x8CE220, 0x10,  0x1A0, 0x48,   0x10,  0x710, 0x0,   0x0,  0x0;
    string128 text_ch2_2    : 0x8CE220, 0x10,  0x1A0, 0x48,   0x10,  0x720, 0x0,   0x0,  0x0;
    string128 text_ch2_3    : 0x8CE220, 0x10,  0x1A0, 0x48,   0x10,  0x730, 0x0,   0x0,  0x0;
    string128 text_ch2_4    : 0x8CE220, 0x10,  0x1A0, 0x48,   0x10,  0x800, 0x0,   0x0,  0x0;
    double namerEvent_ch2   : 0x8BA790, 0x178, 0x70,  0x38,   0x48,  0x10,  0xC0,  0x0;
    double loadedDiskGreyBG : 0x8BA790, 0xE0,  0x48,  0x10,   0xCD0, 0x0;
    double snowgrave        : 0x8BA790, 0x1A0, 0x3B0, 0x88,   0x70,  0x38,  0x1A0, 0x48, 0x10, 0xA0, 0x0;

    double fight_ch3      : 0x6A9CA8, 0x48,  0x10,   0x11A0, 0x370;
    double plot_ch3       : 0x6A9CA8, 0x48,  0x10,   0x1010, 0x250;
    double knightResult   : 0x6A9CA8, 0x48,  0x10,   0x6A80, 0x0,  0x90, 0x4170;
    double namerEvent_ch3 : 0x8BA790, 0x178, 0x70,   0x38,   0x48, 0x10, 0x160, 0x0;
    double eggTimer       : 0x8BA790, 0x1E8, 0x2A0,  0x38,   0x48, 0x10, 0x140, 0x0;
    float mantleOutro     : 0x6A7A98, 0x0,   0x19D0, 0x18,   0x50, 0x10, 0xD0;

    double fight_ch4      : 0x6A9CA8, 0x48,  0x10,   0x72B0, 0x370;
    double plot_ch4       : 0x6A9CA8, 0x48,  0x10,   0x2F70, 0x30;
    double namerEvent_ch4 : 0x8BA790, 0x178, 0x70,   0x38,   0x48,  0x10,  0x80,  0x0;
    string128 text_ch4    : 0x8CE220, 0x10,  0x1A0,  0x48,   0x10,  0x310, 0x0,   0x0,  0x0;
    double mikeAction     : 0x8BA790, 0x1A0, 0x2F0,  0x90,   0x78,  0x38,  0x198, 0x48, 0x10, 0x270, 0x0;
    int susieSprite       : 0x6A7A98, 0x0,   0x1018, 0x50,   0x158, 0x10,  0xBC;
    float playerX         : 0x6A7A98, 0x0,   0x1A8,  0x0,    0x50,  0x158, 0x10,  0xE8;
    ...
    double plot_ch5       : 0x6A9CA8, 0x48,  0x10,   0x850,  0xC0;
    double choicer_ch5    : 0x6A9CA8, 0x48,  0x10,   0x180,  0x20;
    double namerEvent_ch5 : 0x8BA790, 0x178, 0x70,   0x38,   0x48, 0x10, 0xC0,  0x0;
    string128 text_ch5    : 0x8CE220, 0x18,  0x90,   0x0,    0x0,  0x0;
    double pinkCoins      : 0x6A9CA8, 0x48,  0x10,   0x6BA0, 0x0,  0x90, 0x5200;
    double floweryDollars : 0x6A9CA8, 0x48,  0x10,   0x6BA0, 0x0,  0x90, 0x5830;
    int crtStart          : 0x6A7A98, 0x0,   0x1930, 0x8,    0x18, 0x68, 0x10,  0xE4;
...
startup
{
    ...
    vars.splits[3] = new Dictionary<string, Func<string, dynamic, dynamic, bool>>()
    {
        ...
        {"Ch4_HammerofJustice", (ver, org, cur) => cur.roomName == "room_dw_church_arena_ch4" && cur.fight == 1 && org.susieSprite >= 1535 && org.susieSprite <= 1537 && cur.susieSprite >= 1553 && cur.susieSprite <= 1555 && vars.tempVar == 1},
...
init
{
    ...
    switch(hash)
    {
        ...
        case "83A5A14F9B92A20F21FB9EC6C8528469":
        case "5B19C93D46F646F153C8A598079664F6": // 30 TBPS mod
        case "FD15DD732A67BF4A9FC55A7203C55F38": // Item tracker mod
        case "FA6B5F4AA8B7F3027BCD322D831EFABF": // OST% tracker mod
            version = "CH1-5 v253";
            break;
        ...
        default:
            ...
            if(!vars.UnknownPopup)
            {
                ...
                (
                    ...
                    "- Chapters 1-4 v1.02\n" +
                    "- Chapters 1-5 v244, v247, v250, v253.\n\n" +
...
update
{
    ...
    if(current.chapter > 0)
    {
        ...
        switch(ch)
        {
            ...
            case 4:
                if(settings["Ch4_HammerofJustice"] && vars.tempVar == 0 && current.roomName == "room_dw_church_arena_ch4" && current.fight == 1 && (old.susieSprite >= 3128 && old.susieSprite <= 3131) && old.susieSprite != current.susieSprite)
                {
                    vars.tempVar = 1;
                }
                else
